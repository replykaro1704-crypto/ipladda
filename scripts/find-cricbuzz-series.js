// scripts/find-cricbuzz-series.js
const fs = require('fs');
...
async function find() {
    console.log('Searching for IPL 2026 Series on Cricbuzz...');
    try {
        const r = await fetch('https://cricbuzz-cricket.p.rapidapi.com/series/v1/list/intl', {
